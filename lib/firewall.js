 ...
 * @api public
 */
Firewall.prototype.debug = function() {
    console.warn('DEPRECATED, node-firewall use debug package on namespace node-firewall:firewall');
    // only for compat
    process.env.DEBUG = 'node-firewall:firewall';
};
